...
declare module 'p5' {
  export default class p5 {
     ...
     *   array.
     *
     *   @param color Color object, color components, or
     *   CSS color
     ...
     *   the background of the js canvas. The default
     ...
     *
     *
     *   A Color object can also be provided to set the
     *   background color.
     *
     *
     *   A Image can also be provided to set the
     *   background iamge.
     *
     ...
     *   only works on Canvas objects created with the
    ...
    /**
     *   colorMode() changes the way js interprets color
     ...
     *   set the mode which js interprates and
     ...
     *   canvas and any elements created by js. It will
    ...
    /**
     *   Confirms if the window a js program is in is
    ...
    /**
     *   Creates and returns a new Renderer object. Use
    ...
    /**
     *   Stops js from continuously executing the code
    ...
    /**
     *   By default, js loops through draw()
    ...
    // src/data/TypedDict.js

    /**
     *   Creates a new instance of StringDict using the
     *   key, value pair or object you provide.
     *
     *   @param key or object
     */
    createStringDict(key: string|object, value: string): StringDict

    /**
     *   Creates a new instance of NumberDict using the
     *   key, value pair or object you provide.
     *
     *   @param key or object
     */
    createNumberDict(key: number|object, value: number): NumberDict
    ...
    /**
     *   Creates a new Image (the datatype for storing
    ...
    /**
     *   Loads an image from a path and creates a Image
    ...
    /**
     *   Draw an image to the js canvas. This function
     ...
     *   these parameters, js uses the language of
     ...
     *   Color object, or [R, G, B, A] pixel array. It
     ...
     *   | a Color object | a Image to copy
     */
     ...
     *   to a canvas Element, an Array of Strings, an
     *   Array of JSON, a JSON object, a Table, a
     *   Image, or a SoundFile (requires sound).
     ...
     *   Renderer object as an image var gb =
     *   createGraphics(100, 100); save(gb,
     *   'myGraphics.jpg'); var myTable = new Table();
    ...
    /**
     *   Creates a new Vector (the datatype for storing
     ...
     *   noiseSeed() function). js can compute 1D, 2D
     ...
     *   @return Font object
     */
    loadFont(path: string, callback?: Function, onError?: Function): Font
    ...
    /**
     *   js communicates with the clock on your
     ...
     *   the model to a scale appropriate for  You can
     ...
     *
     *   @param [s] the desired Shader to use for
     *   rendering shapes.
     *   @chainable
     */
    shader(s?: Shader): p5
     ...
     *   Element. If a class or tag name is given with
     ...
     *   search for
     *   @param [container] id, Element, or HTML element
     *   to search within
     *   @return Element containing node found
     */
    select(name: string, container?: string): object|Element|null
     ...
     *   as Elements in an array. The DOM node itself
     ...
     *   @param [container] id, Element, or HTML element
     *   to search within
     *   @return Array of Elements containing nodes
     *   found
     */
     ...
     *   @return pointer to Element holding created node
     */
    createDiv(html?: string): object|Element
     ...
     *   @return pointer to Element holding created node
     */
    createP(html?: string): object|Element
     ...
     *   @return pointer to Element holding created node
     */
    createSpan(html?: string): object|Element
     ...
     *   @return pointer to Element holding created node
     */
    createImg(src: string, alt?: string, successCallback?: Function): object|Element
     ...
     *   @return pointer to Element holding created node
     */
    createA(href: string, html: string, target?: string): object|Element
     ...
     *   @return pointer to Element holding created node
     */
    createSlider(min: number, max: number, value?: number, step?: number): object|Element
     ...
     *   @return pointer to Element holding created node
     */
    createButton(label: string, value?: string): object|Element
     ...
     *   @return pointer to Element holding created node
     */
    createCheckbox(label?: string, value?: boolean): object|Element

    /**
     *   Creates a dropdown menu <select></select> element
     *   in the DOM. It also helps to assign select-box
     *   methods to Element when selecting existing
     *   select box
     *
     ...
     *   @return pointer to Element holding created node
     */
    createRadio(divId?: string): object|Element
     ...
     *   @return pointer to Element holding created node
     */
    createInput(value?: string, type?: string): object|Element
     ...
     *   selected
     *   @return pointer to Element holding created DOM
     *   element
     */
    createFileInput(callback?: Function, multiple?: string): object|Element
     ...
     *   @return pointer to video Element
     */
    createVideo(src: string|any[], callback?: object): MediaElement|Element
     ...
     *   to its end without having to stop for further
     *   buffering of content
     *   @return pointer to audio Element /**
     */
    createAudio(src?: string|string[], callback?: object): MediaElement|Element
     ...
     *   has loaded
     *   @return capture video Element
     */
    createCapture(type: string|any|object, callback: Function): object|Element
     ...
     *   @return pointer to Element holding created node
     */
    createElement(tag: string, content?: string): object|Element

    // Properties from sound
     ...
     *   Works: When you load the sound module, it
    ...
    /**
     *   soundOut is the sound master output. It
  ...
  export class Element {
     ...
     *   dom library. It is not called directly, but
     *   Element objects are created by calling
     *   createCanvas, createGraphics, or in the dom
     ...
     *   Element. If no arguments given, parent node is
     *   returned. For more ways to position the canvas,
     *   see the  positioning the canvas wiki page.
     *
     *   @param parent the ID, DOM node, or Element of
     ...
     *   @chainable
     */
    touchStarted(fxn: Function|boolean): Element
     ...
     *   @chainable
     */
    touchMoved(fxn: Function|boolean): Element
     ...
     *   @chainable
     */
    touchEnded(fxn: Function|boolean): Element
     ...
     *   that is passed a File object. You can
     ...
     */
    addClass(theClass: string): object|Element
     ...
     */
    removeClass(theClass: string): object|Element

    /**
     *   Attaches the element as a child to the parent
     *   specified. Accepts either a string ID, DOM node,
     *   or Element. If no argument is specified, an
     *   array of children DOM nodes is returned.
     *
     *   @param [child] the ID, DOM node, or Element to
     *   add to the current element
     */
    child(child?: string|object|Element): Element
     ...
     */
    center(align?: string): object|Element
     ...
     */
    html(html?: string, append?: boolean): object|Element|string
     ...
     *   window
     */
    position(x?: number, y?: number): object|Element
     ...
     *   specified or Element
     */
    style(property: string, value?: string|number|Color, value2?: string|number|Color, value3?: string|number|Color): string|object|Element
     ...
     *   specified or Element
     */
    attribute(attr: string, value?: string): string|object|Element
     ...
     */
    removeAttribute(attr: string): object|Element
     ...
     *   or Element
     */
    value(value?: string|number): string|object|Element
     ...
     *   a number
     */
    size(w?: number|any, h?: number|any): object|Element
  ...
  export class Graphics extends Element {
    /**
  ...
  export class Renderer extends Element {
     ...
     *   the base API implementation for js "core". To
  ...
  export class TypedDict {
    /**
     *   Base class for all Dictionary types. More
  ...
  export class StringDict extends TypedDict {
    /**
  ...
  export class NumberDict extends TypedDict {
    /**
  ...
  export class Image {
    /**
     *   Creates a new Image. A Image is a canvas
     ...
     *   function. The Image class contains fields for
     ...
     *   region is extracted and a Image is returned.
     *
     ...
     *   into this Image. Note that for a large number
    ...
    /**
     *   Applies an image filter to a Image
     *
     *   @param filterType either THRESHOLD, GRAY, OPAQUE,
     *   INVERT, POSTERIZE, BLUR, ERODE, DILATE or BLUR.
     *   See Filters.js for docs on each available filter
  ...
  export class Table {
     ...
     *
     *   @param [rows] An array of TableRow objects
     */
     ...
     *   Table object. By default, an empty row is
     ...
     *   using set(). If a TableRow object is included
  ...
  export class XML {
     ...
     *   of XML objects. When the name parameter is
     ...
     *   an existing XML object. A reference to the
     *   newly created child is returned as an XML
     *   object.
     *
     *   @param a XML Object which will be the child to
     *   be added
     */
    addChild(a: XML): void
  ...
  export class Vector {
     ...
     *   and heading().  In many of the js examples, you
     *   will see Vector used to describe a position,
     ...
     *   the methods inside the Vector class.
     *
     *   @param [x] x component of the vector
     *   @param [y] y component of the vector
     *   @param [z] z component of the vector
     ...
     *   Vector, or the values from a float array.
     *
    ...
    /**
     *   Gets a copy of the vector, returns a Vector
     *   object.
     *
     *   @return the copy of the Vector object
     */
    copy(): Vector
     ...
     *   Vector, the others acts directly on the vector.
     ...
     *   returns a Vector, the other acts directly on
     ...
     *   the vector. See the examples for more context.
     *
     *   @param v1 a Vector to subtract from
     ...
     *   version of this method creates a new Vector
     ...
     *   of this method creates a new Vector while the
     ...
     *   and non static methods return a new Vector. See
     *   the examples for more context.
     *
     *   @param v Vector to be crossed
     *   @return Vector composed of cross product
     */
     ...
     *   between two vectors.
     *
     *   @param the x, y, and z components of a Vector
     *   @return the angle between (in radians)
     */
    angleBetween(the: Vector): number
     ...
     *   by using the Vector.copy() method to copy into
     *   your own array.
     *
  ...
  // src/webgl/RendererGL.js
  export class RendererGL extends Renderer {
    /**
     ...
     *   @chainable
     */
    constructor(v1: number|number[]|string|Color, v2?: number, v3?: number, a?: number)

    // src/webgl/RendererGL.Immediate.js
     ...
     *   please use js geometry primitives.
     *
     ...
     *   @chainable
     */
    beginShape(mode: number): RendererGL
     ...
     *   @chainable
     */
    vertex(x: number, y: number, z: number): RendererGL
     ...
     *   @param [a] opacity
     */
    stroke(v1: number|number[]|string|Color, v2?: number, v3?: number, a?: number): void
  ...
  export class Shader {
     ...
     *
     *   @param renderer an instance of RendererGL that
     *   will provide the GL context for this new Shader
  ...
  export class Texture {
     ...
     */
    constructor(renderer: RendererGL, obj?: Image|Graphics|Element|MediaElement)
  ...
  export class MediaElement {
    /**
     *   Extends Element to handle audio and video. In
     *   addition to the methods of Element, it also
     *   contains methods for controlling media. It is not
     *   called directly, but MediaElements are created
     ...
     *   autoplay
     */
    autoplay(autoplay: boolean): object|Element
     ...
     *   @return current volume or MediaElement
     */
    volume(val?: number): number|MediaElement
     ...
     *   playback
     *   @return current playback speed or MediaElement
     */
    speed(speed?: number): number|object|MediaElement
     ...
     *   MediaElement
     */
    time(time?: number): number|object|MediaElement
     ...
     */
    onended(callback: Function): object|MediaElement

    /**
     *   Send the audio output of this element to a
     *   specified audioNode or sound object. If no
     ...
     *   is meant to be used with the sound.js addon
     *   library.
     *
     *   @param audioNode AudioNode from the Web Audio API,
     *   or an object from the sound library
     */
  ...
  export class SoundFile {
     ...
     *   SoundFile may not be available immediately
    ...
    /**
     *   loadSound() returns a new SoundFile from a
     *   specified path. If called during preload(), the
     *   SoundFile will be ready to play in time for
     *   setup() and draw(). If called outside of preload,
     *   the SoundFile will not be ready immediately, so
    ...
    /**
     *   SoundFile has two play modes: restart and
     *   sustain. Play Mode determines what happens to a
     *   SoundFile if it is triggered while in the
     ...
     *   position. If SoundFile had been set to loop
    ...
    /**
     *   Loop the SoundFile. Accepts optional parameters
    ...
    /**
     *   Set a SoundFile's looping flag to true or
    ...
    /**
     *   Returns 'true' if a SoundFile is currently
    ...
    /**
     *   Returns true if a SoundFile is playing, false
    ...
    /**
     *   Returns true if a SoundFile is paused, false if
    ...
    /**
     *   Set the stereo panning of a sound object to a
    ...
    /**
     *   Return the current position of the SoundFile
     ...
     *   SoundFile that can be used to draw a static
     *   waveform. Scans through the SoundFile's audio
     ...
     *   of another sound object. For example, you may
     *   connect a SoundFile to an FFT or an Effect. If
  ...
  export class FFT {
     ...
     *   a FFT object can return an array based on two
     *   types of analyses:
     *
     ...
     *   the sketch.
     *
     *   @param [source] sound object (or web audio API
     *   source node)
     */
  ...
  export class Signal {
    /**
     *   Signal is a constant audio-rate signal used by
     *   Oscillator and Envelope for modulation math.
     ...
     *   sound, and returns a Tone.Signal from the
    ...
    /**
     *   Connect a sound object or Web Audio node to
     *   this Signal so that its amplitude values can be
     *   scaled.
     *
     */
  ...
  export class Oscillator {
     ...
     *   instantiating a specific oscillator: SinOsc,
     *   TriOsc, SqrOsc, or SawOsc.
     *
    ...
    /**
     *   Connect to a sound / Web Audio object.
     *
     *   @param unit A sound or Web Audio object
     */
    ...
    /**
     *   Add a value to the Oscillator's output
    ...
    /**
     *   Multiply the Oscillator's output amplitude by a
  ...
  export class SinOsc extends Oscillator {
    /**
     *   Constructor: new SinOsc(). This creates a Sine
     *   Wave Oscillator and is equivalent to  new
     *   Oscillator('sine')  or creating a Oscillator
     *   and then calling its method setType('sine'). See
     *   Oscillator for methods.
     *
  ...
  export class TriOsc extends Oscillator {
    /**
     *   Constructor: new TriOsc(). This creates a
     *   Triangle Wave Oscillator and is equivalent to new
     *   Oscillator('triangle')  or creating a
     *   Oscillator and then calling its method
     *   setType('triangle'). See Oscillator for
     *   methods.
     *
     *   @param [freq] Set the frequency
     */
  ...
  export class SawOsc extends Oscillator {
    /**
     *   Constructor: new SawOsc(). This creates a
     *   SawTooth Wave Oscillator and is equivalent to  new
     *   Oscillator('sawtooth')  or creating a
     *   Oscillator and then calling its method
     *   setType('sawtooth'). See Oscillator for
     *   methods.
     *
     *   @param [freq] Set the frequency
     */
  ...
  export class SqrOsc extends Oscillator {
    /**
     *   Constructor: new SqrOsc(). This creates a
     *   Square Wave Oscillator and is equivalent to  new
     *   Oscillator('square')  or creating a
     *   Oscillator and then calling its method
     *   setType('square'). See Oscillator for methods.
     *
     *   @param [freq] Set the frequency
     */
    constructor(freq?: number)
  ...
  export class Env {
     ...
     *   Web Audio Parameters—for example, a Env can
     ...
     *   envelope. If a Sound object is given, then the
     *   Env will control its output gain. If multiple
     *   inputs are provided, the env will control all of
     *   them.
     *
     *   @param [inputs] A sound object or Web Audio
     *   Param.
     */
     ...
     *   input. If the input is a sound object (i.e.
     ...
     *
     *   @param unit A sound object or Web Audio Param.
     ...
     *   you let go. Input can be any sound object, or a
     *   Web Audio Param.
     *
     *   @param unit sound Object or Web Audio Param
     ...
     *   output
     */
    add(number: number): Env

    /**
     *   Multiply the Env's output amplitude by a fixed
     ...
     *   output
     */
    scale(inMin: number, inMax: number, outMin: number, outMax: number): Env
  }
  ...
  export class Pulse extends Oscillator {
     ...
     *   pulses. See  Oscillator for a full list of
     *   methods.
     *
  ...
  export class Noise extends Oscillator {
    ...
    /**
     *   Send output to a sound or web audio object
     *
     */
    connect(unit: object): void
  ...
  export class AudioIn {
     ...
     *   sound output by default to prevent feedback.
     *
     ...
     *   sound's output. So you won't hear anything
  ...
  export class Effect {
    /**
     *   Effect is a base class for audio effects in
     *   This module handles the nodes and methods that are
     *   common and useful for current and future effects.
     *
     *   This class is extended by Distortion,
     *   Compressor, Delay, Filter, Reverb.
     *
    ...
    /**
     *   Send output to a js-sound, Web Audio Node, or
  ...
  export class Filter extends Effect {
    /**
     *   A Filter uses a Web Audio Biquad Filter to
     *   filter the frequency response of an input source.
     *   Subclasses include:
     *
     *   - LowPass: Allows frequencies below the cutoff
     *   frequency to pass through, and attenuates
     *   frequencies above the cutoff.
     *   - HighPass: The opposite of a lowpass filter.
     *   - BandPass: Allows a range of frequencies to
     ...
     *   frequency.
     *
     *   This class extends Effect. Methods amp(),
    ...
    /**
     *   The Filter is built with a  Web Audio
     *   BiquadFilter Node.
     *
     */
     ...
     *   inherited from Effect .amp() controls the
     *   volume via the output gain node Filter.gain()
    ...
    /**
     *   Set the type of a Filter. Possible types
  ...
  export class LowPass extends Filter {
    /**
     *   Constructor: new LowPass() Filter. This is the
     *   same as creating a Filter and then calling its
     *   method setType('lowpass'). See Filter for
     *   methods.
     *
     */
    constructor()
  ...
  export class HighPass extends Filter {
    /**
     *   Constructor: new HighPass() Filter. This is the
     *   same as creating a Filter and then calling its
     *   method setType('highpass'). See Filter for
     *   methods.
     *
     */
    constructor()
  ...
  export class BandPass extends Filter {
    /**
     *   Constructor: new BandPass() Filter. This is the
     *   same as creating a Filter and then calling its
     *   method setType('bandpass'). See Filter for
     *   methods.
     *
     */
    constructor()
  ...
  export class EQ extends Effect {
    /**
     *   EQ is an audio effect that performs the
     ...
     *   filtering out parts of the spectrum. EQ is
     ...
     *   directly modifying EQ.bands (the array that
     *   stores filters). This class extends Effect.
    ...
    /**
     *   The EQ is built with abstracted Filter
     *   objects. To modify any bands, use methods of the
     *   Filter API, especially gain and freq. Bands are
  ...
  export class Panner3D {
     ...
     *   soundOut.audiocontext.listener
     *
     */
    constructor()
  ...
  export class Delay extends Effect {
     ...
     *   that sound. The Delay can produce different
     ...
     *   original source. This class extends Effect.
     *   Methods amp(), chain(), drywet(), connect(), and
     *   disconnect() are available.
     *
     */
    ...
    /**
     *   The Delay is built with two  Web Audio Delay
     ...
     *   cutoff, or an object (i.e. a Oscillator) that
  ...
  export class Reverb extends Effect {
     ...
     *   space. The Reverb has paramters for Time (how
     ...
     *   Convolver extends Reverb allowing you to
     *   recreate the sound of actual physical spaces
     *   through convolution. This class extends Effect.
     *   Methods amp(), chain(), drywet(), connect(), and
     *   disconnect() are available.
     *
     */
     ...
     *   parameters.
     *
     *   @param src sound / Web Audio object with a
     *   sound output.
  ...
  export class Convolver extends Effect {
    /**
     *   Convolver extends Reverb. It can emulate the
     ...
     *   instantiate a Convolver with a path to your
    ...
    /**
     *   Internally, the Convolver uses the a  Web Audio
     *   Convolver Node.
     *
     */
    ...
    /**
     *   Create a Convolver. Accepts a path to a
     ...
     */
    createConvolver(path: string, callback?: Function, errorCallback?: Function): Convolver
     ...
     *   Convolver. The impulse is added to the
     ...
     *   impulses to a Convolver, then you can use this
     ...
     *   Parts. This method will impact all active
     *   Parts.
     *
  ...
  export class Phrase {
     ...
     *   added to a Part for playback, and each part can
  ...
  export class Part {
     ...
     *
     *   @param phrase reference to a Phrase
     */
  ...
  export class Score {
     ...
     *   play them back in this order new Score(a, a, b,
     *   a, c)
     *
  ...
  export class SoundLoop {
     ...
     *
     *   @param otherLoop a SoundLoop to sync with
  ...
  export class Compressor extends Effect {
     ...
     *   class extends Effect. Methods amp(), chain(),
    ...
    /**
     *   The Compressor is built with a Web Audio
  ...
  export class SoundRecorder {
    ...
    /**
     *   Connect a specific device to the SoundRecorder.
     *   If no parameter is given, SoundRecorer will
     *   record all audible sound from your sketch.
     *
     *   @param [unit] sound object or a web audio unit
     *   that outputs sound
     */
     ...
     *   a SoundFile as the first parameter. The
     *   SoundRecorder will send its recording to that
     *   SoundFile for playback once recording is
     ...
     *   has been transfered to the SoundFile.
     *
     ...
     */
    record(soundFile: SoundFile, duration?: number, callback?: Function): void

    /**
     *   Stop the recording. Once the recording is stopped,
     *   the results will be sent to the SoundFile that
    ...
    /**
     *   Save a SoundFile as a .wav audio file.
     *
     *   @param soundFile SoundFile that you wish to
     *   save
     *   @param name name of the resulting .wav file.
     */
    saveSound(soundFile: SoundFile, name: string): void
  }


  export class PeakDetect {
    /**
     *   PeakDetect works in conjunction with FFT to
     *   look for onsets in some or all of the frequency
     *   spectrum.   To use PeakDetect, call update in
     *   the draw loop and pass in a FFT object.
     *
     *
    ...
    // TODO: Annotate attribute "isDetected", defined in lib/addons/sound.js, line 11388
  ...
  export class PolySynth {
     ...
     *   that is triggered. The PolySynth defaults to
     *   using the MonoSynth as its voice.
     *
     */
    AudioVoice: any
  ...
  export class Distortion extends Effect {
    ...
    /**
     *   The Distortion is built with a  Web Audio
     *   WaveShaper Node.
     *
     */
