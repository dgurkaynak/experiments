...
export default class FaceDeformer {
  ...
  constructor(public imageData: ImageData, landmarkPoints: Number[][], width: number, height: number) {
    ...
    VERTICE_MAP.forEach(([i1, i2, i3]) => {
      ...
      textureVertices.push(p1[0] / imageData.width);
      textureVertices.push(p1[1] / imageData.height);
      textureVertices.push(p2[0] / imageData.width);
      textureVertices.push(p2[1] / imageData.height);
      textureVertices.push(p3[0] / imageData.width);
      textureVertices.push(p3[1] / imageData.height);
    });
